...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `ttep_messages` (`receiver`, `sender`, `message`, `readstatus`) VALUES (?, ?, ?, ?)");

        try {
            $stmt->execute([ $receiver, $sender, $message, $readstatus ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: ttep_messages-read.php?id=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="ttep_messages-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
