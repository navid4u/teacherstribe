...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['ttep_messages']['columns'])) {
        foreach ($tables_and_columns_names['ttep_messages']['columns'] as $columnName => $columnDetails) {
    ...
    $sql = "DELETE FROM `ttep_messages` WHERE `id` = ?";
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if (!isset($error)){
            ...
            header("location: ttep_messages-index.php");
        }
    }
