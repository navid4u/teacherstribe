...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['ttep_premium']['columns'])) {
        foreach ($tables_and_columns_names['ttep_premium']['columns'] as $columnName => $columnDetails) {
    ...
    $sql = "DELETE FROM `ttep_premium` WHERE `id` = ?";
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if (!isset($error)){
            ...
            header("location: ttep_premium-index.php");
        }
    }
