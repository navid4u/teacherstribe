...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `ttep_premium` (`username`, `trans_id`, `id_get`, `plan`) VALUES (?, ?, ?, ?)");

        try {
            $stmt->execute([ $username, $trans_id, $id_get, $plan ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: ttep_premium-read.php?id=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="ttep_premium-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
