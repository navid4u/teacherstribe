...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `ttep_reminder` (`ttep_teacher_username`, `date`, `title`, `done`, `detail`) VALUES (?, ?, ?, ?, ?)");

        try {
            $stmt->execute([ $ttep_teacher_username, $date, $title, $done, $detail ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: ttep_reminder-read.php?id_ttep_reminder=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="ttep_reminder-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
