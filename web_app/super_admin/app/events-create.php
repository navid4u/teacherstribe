...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `events` (`title`, `description`, `eventscol`, `start_date`, `end_date`, `posted_by`) VALUES (?, ?, ?, ?, ?, ?)");

        try {
            $stmt->execute([ $title, $description, $eventscol, $start_date, $end_date, $posted_by ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: events-read.php?id=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="events-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
