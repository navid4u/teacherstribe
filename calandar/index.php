...
<body>
	...
	<div id='calendar-container'>
  	...
  	<!-- Fullcalendar  -->
	<script type="text/javascript" src="/calandar/fullcalendar/dist/index.global.min.js"></script>
	...
	document.addEventListener('DOMContentLoaded', function() {
	    ...
	    var calendar = new FullCalendar.Calendar(calendarEl, {
	      	...
	      	events: '/calandar/fetchevents.php', // Fetch all events
